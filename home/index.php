...
<body>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed">
          ...
          <li class="bold"><a href="index.php?menus=Diagnosa" class="waves-effect waves-cyan"><i class="mdi-action-assignment-turned-in"></i> Konsultasi Perbaikan</a></li>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>System Copyright &copy; 2018 <a class="grey-text text-lighten-4" href="#">M. Iqbal | 1406082</a>. All rights reserved.</span>
