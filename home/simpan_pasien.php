                ...
                <div class="col s12 m12">
                    <ul id="projects-collection" class="collection">
                      ...
                      foreach ($pesanError as $indeks=>$pesan_tampil) { 
                        ...
                        $sqlSim =  mysql_query("INSERT INTO tmp_pasien(id,nama_pasien,jenkel,alamat,noip,tanggal)VALUES('','$TxtNama','$CmbJenkel','$TxtAlamat','$NoIP',NOW())")or die ("GAGAL EKSEKUSI DATA PASIEN. ERROR : ".mysql_error());
