...
if($hasil_cek == 1){
    ...
    $sql_sim_analisa = mysql_query("INSERT INTO analisa_hasil (nama_pasien,kelamin,alamat,kode_penyakit,noip,tanggal)values('$hasil_pasien[nama_pasien]','$hasil_pasien[jenkel]','$hasil_pasien[alamat]','$hasil_data[kode_penyakit]','$hasil_pasien[noip]','$hasil_pasien[tanggal]')") or die("GAGAL EKSEKUSI DATA. ERROR : ".mysql_error());
    DelTmpAnalisa($NoIP);
    DelTmpGejala($NoIP);
    DelTmpPasien($NoIP);
    DelTmpSakit($NoIP);
                      ...
                      <form class="col s12" method="post" action="index.php?menus=Cek_Analisa">
                        <div class="row">
                          <div class="input-field col s12">
                            <span>
                              Apakah AC Anda mengalami gejala <?php echo $gejala;?> ( <?php echo $kode_gejala;?> )?
