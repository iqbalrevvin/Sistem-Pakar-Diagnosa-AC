        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Data Kerusakan</li>
                </ol>
            </section>
            <!-- Main content -->
            <section class="content">
                ...
                <div class="box box-info">
                    <div class="box-header">
                      <h3 class="box-title">Tabel Data Kerusakan</h3>
                      ...
                      <table id="example2" class="table table-bordered table-striped">
                        <thead>
                          <tr>
                            ...
                            <th style="width: 100px; text-align: center;">Kode Kerusakan</th>
                            <th style="text-align: center;">Nama Kerusakan</th>
                            <!--<th style="text-align: center;">Nama Lain Kerusakan</th>-->
