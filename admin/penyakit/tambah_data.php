        ...
        <div class="content-wrapper">
                    ...
                    <form class="form-horizontal" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="Txt_Kode" class="form-control" placeholder="Kode Kerusakan" value="<?php echo $dataKode;?>" readonly="readonly"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nama Kerusakan</label>
                                <div class="col-sm-6">
                                    <input type="text" name="Txt_Nama" class="form-control" placeholder="Masukkan Nama Kerusakan" value="<?php echo $dataNama;?>"/>
                                </div>
                            </div>
                            <!--<div class="form-group">
            ...
            <?php
                if(isset($_POST['Tb_Simpan'])){
                	...
                	if (trim($TxtKode)=="") {
                		$pesanError[] = "<b>Kode Kerusakan</b> Belum Dibuat !";			
                	}
                    if (trim($TxtNama)=="") {
                		$pesanError[] = "<b>Nama Kerusakan</b> Masih Kosong !";			
                    ...
                    if ($cek_nama > 0){
                        $pesanError[] = "<b>Nama Kerusakan</b> sudah ada. Silahkan ganti nama Kerusakan yang lain.";
                    }
                    $cek_latin = mysql_num_rows(mysql_query("SELECT nama_latin FROM tbl_penyakit WHERE nama_latin = '".$TxtLatin."'"));
                    if ($cek_latin > 0){
                        $pesanError[] = "<b>Nama Latin Kerusakan</b> sudah ada. Silahkan ganti nama latin Kerusakan yang lain.";
                    }
